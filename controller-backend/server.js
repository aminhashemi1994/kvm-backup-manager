...
const missedBackupsRoutes = require('./routes/missedBackups');
...
app.use('/api/missed-backups', authenticateUser, missedBackupsRoutes);
app.use('/api/metrics', authenticateUser, metricsRoutes);
app.use('/api/fix-backup', authenticateUser, fixBackupRoutes);
app.use('/api/cleanup-backup', authenticateUser, cleanupBackupRoutes);
app.use('/api/backup-status', authenticateUser, backupStatusRoutes);
